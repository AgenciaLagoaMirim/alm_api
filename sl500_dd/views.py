...
class DataReceptionSL500(viewsets.ViewSet):
    ...
    def process_data(self, raw_data):
        if '#' in raw_data:
            ...
            return {
                "SL500": first_line_parts,
                "SL500P": sl500p_data
            }
        else:
            return {
                'error': 'No "#" found in the data'
            }

    def create(self, request):
        raw_data = request.data.get('DADOS', '')  # Assuming 'DADOS' is the key for your raw data
        station_name = request.data.get('st_name', None)  # Assuming 'STATION_NAME' is the key for the station name
        ...
        try:
            ...
            sl500 = Sl500.objects.create(
                ...
                local_date=datetime.now(),  # Ajuste conforme necessário
                station=station  # Ajuste conforme necessário
            )
